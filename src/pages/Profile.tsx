  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="fixed top-4 right-4 z-10">
        <button className="w-10 h-10 rounded-xl bg-[hsl(150,80%,20%)] flex items-center justify-center text-white shadow-lg hover:opacity-90 transition-opacity">
      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-md text-center animate-fade-in">
          {/* Avatar */}
          <div className="w-24 h-24 rounded-full bg-gradient-to-br from-lime-400 to-green-600 flex items-center justify-center text-white font-bold text-3xl mx-auto mb-4 overflow-hidden shadow-xl ring-4 ring-white">
            {profile?.avatar_url ? (
          ...
          <form onSubmit={handleSubscribe} className="flex gap-2 mb-6 bg-gray-50 p-1.5 rounded-xl">
            ...
            <Button 
              ...
              className="h-11 px-6 bg-[hsl(150,80%,20%)] hover:opacity-90 text-white font-semibold"
            >
